...
plot6= ggplot(eduwa4, aes(x=Student.Teacher.Ratio)) + geom_histogram()

plot7= plot6 +(eduwa4, aes(x=Student.Teacher.Ratio)) + 
  geom_histogram(binwidth=1) 

plot8 =plot7 +(eduwa4, aes(x=Student.Teacher.Ratio)) + 
  geom_histogram(color="black", fill="white",+ scale_x_continuous (limits=c(0,150))

                 
                 
plot8 + scale_x_continuous (limits=c(0,150)
